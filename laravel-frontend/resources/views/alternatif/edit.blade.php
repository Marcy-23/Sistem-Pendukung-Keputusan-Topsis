...
@section('title', 'Edit Produk Plastik - SPK TOPSIS Plastik')
...
@section('content')
    ...
    <div class="kartu" style="max-width: 600px;">
        <div class="kartu-header">
            <h2><i class="bi bi-pencil-square"></i> Edit Produk Plastik</h2>
        </div>
        <div style="padding: 20px;">
            <form action="{{ url('/alternatif/edit/' . $alt['idAlternatif']) }}" method="POST">
                @csrf

                <div class="form-group" style="margin-bottom: 15px;">
                    <label for="kode_alternatif" style="display: block; font-weight: bold; margin-bottom: 5px;">Kode Produk</label>
                    <input type="text" id="kode_alternatif" name="kode_alternatif" value="{{ $alt['kodeAlternatif'] }}" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px; box-sizing: border-box;">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <input type="text" id="nama_alternatif" name="nama_alternatif" value="{{ $alt['namaAlternatif'] }}" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px; box-sizing: border-box;">
                </div>
